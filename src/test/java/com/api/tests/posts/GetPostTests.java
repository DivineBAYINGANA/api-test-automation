...
public class GetPostTests extends TestBase {
        ...
        @Order(8)
        @AllureId("P-108")
        @DisplayName("GET /posts — response should match post list JSON schema")
        @Severity(SeverityLevel.CRITICAL)
        @Description("API: GET /posts. Validates that the response array matches the expected post list JSON schema.")
